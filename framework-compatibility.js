...
class FrameworkCompatibilityModule {
   ...
   */
  cleanup() {
    if (this.adapter && typeof this.adapter.cleanup === 'function') {
...
class BaseFrameworkAdapter {
  ...
  /**
   * Clean up patches and event listeners
   */
  cleanup() {
    // Restore original methods
    this.patches.forEach(patch => {
      if (patch.target && patch.method && patch.original) {
...
class ReactAdapter extends BaseFrameworkAdapter {
  ...
  enhanceContentDetection(contentDetector) {
      ...
      if (window.__REACT_DEVTOOLS_GLOBAL_HOOK__) {
        try {
          ...
          if (hook.onCommitFiberRoot && !hook._patchedByAccessibility) {
            ...
            // Store patch for cleanup
            this.patches.push({
              target: hook,
              method: 'onCommitFiberRoot',
              original: originalOnCommitFiberRoot
            });
          }
        } catch (e) {
    ...
    enhancedDetector._analyzeReactUpdate = function(root) {
      ...
      if (typeof this.processDetectedContent === 'function') {
...
class VueAdapter extends BaseFrameworkAdapter {
  ...
  enhanceContentDetection(contentDetector) {
    ...
    enhancedDetector._handleVueAttributes = function() {
      // Vue.js uses specific attributes for binding and directives
      // This method would implement special handling for them
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = FrameworkCompatibilityModule;
}